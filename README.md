...
- Convert your active browser tab to markdown with Browser Extension integration
...
- Browser Tab to Markdown
  - Use clipboard fallback when no browser tab is found
  - Auto-copy markdown to clipboard
  - Silent mode for headless operation

## Browser Tab to Markdown

The new Browser Tab to Markdown command allows you to convert your currently active browser tab to markdown without having to copy and paste the URL.

- Requires the Raycast Browser Extension
- Falls back to clipboard content when enabled
- Silent mode for headless operation with toast notifications
